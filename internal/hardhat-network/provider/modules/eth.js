...
class EthModule {
    ...
    async _callAction(rpcCall, blockTag) {
        ...
        if (error !== undefined && this._throwOnCallFailures) {
            const callReturnData = (_a = trace === null || trace === void 0 ? void 0 : trace.returnData.toString("hex")) !== null && _a !== void 0 ? _a : "";
    ...
    async _sendTransactionAndReturnHash(tx) {
        ...
        if (trace.error !== undefined && this._throwOnTransactionFailures) {
            const e = trace.error;
            const returnData = (_b = (_a = trace.trace) === null || _a === void 0 ? void 0 : _a.returnData.toString("hex")) !== null && _b !== void 0 ? _b : "";
